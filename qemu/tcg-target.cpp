    ...
    int label_index, intptr_t addend)
{
    ...
    if (l->has_value) {
        ...
        r = static_cast<TCGRelocation*>(tcg_malloc(s, sizeof(TCGRelocation)));
        r->type = type;
        r->ptr = code_ptr;
        r->addend = addend;
...
{
    tcg_out_mov(s, type, (TCGReg)ret, (TCGReg)arg);
}
...
static void tcg_out_movi(TCGContext* s, TCGType type,
    TCGArg ret, tcg_target_long arg)
{
    tcg_out_movi(s, type, (TCGReg)ret, arg);
}

static inline TCGCond tcg_invert_cond(TCGArg c)
{
    return tcg_invert_cond((TCGCond)c);
}
...
static inline void tcg_out_ld(TCGContext* s, TCGType type, TCGArg ret,
    TCGArg arg1, intptr_t arg2)
{
    tcg_out_ld(s, type, (TCGReg)ret, (TCGReg)arg1, arg2);
}
...
static inline void tcg_out_st(TCGContext* s, TCGType type, TCGArg arg,
    TCGArg arg1, intptr_t arg2)
{
    tcg_out_st(s, type, (TCGReg)arg, (TCGReg)arg1, arg2);
}
...
{
    /* movzbl */
    EMASSERT(src < 4 || TCG_TARGET_REG_BITS == 64);
...
static void tcg_out_brcond32(TCGContext* s, TCGArg cond,
    TCGArg arg1, TCGArg arg2, int const_arg2,
    int label_index, int small)
{
    tcg_out_brcond32(s, (TCGCond)cond, arg1, arg2, const_arg2, label_index, small);
}
...
static void tcg_out_setcond32(TCGContext* s, TCGArg cond, TCGArg dest,
    TCGArg arg1, TCGArg arg2, int const_arg2)
{
    tcg_out_setcond32(s, (TCGCond)cond, dest, arg1, arg2, const_arg2);
}
...
static void tcg_out_movcond32(TCGContext* s, TCGArg cond, TCGArg dest,
    TCGArg c1, TCGArg c2, int const_c2,
    TCGArg v1)
{
    tcg_out_movcond32(s, (TCGCond)cond, dest, c1, c2, const_c2, v1);
}
...
static void tcg_add_target_add_op_defs(const TCGTargetOpDef* tdefs)
{
    TCGOpcode op;
    TCGOpDef* def;
    const char* ct_str;
    ...
    for (;;) {
        ...
        for (i = 0; i < nb_args; i++) {
            ...
            EMASSERT(ct_str != NULL);
            tcg_regset_clear(def->args_ct[i].u.regs);
            def->args_ct[i].ct = 0;
            if (ct_str[0] >= '0' && ct_str[0] <= '9') {
                int oarg;
                oarg = ct_str[0] - '0';
                EMASSERT(oarg < def->nb_oargs);
                EMASSERT(def->args_ct[oarg].ct & TCG_CT_REG);
        ...
        EMASSERT(i == TCG_MAX_OP_ARGS || tdefs->args_ct_str[i] == NULL);
