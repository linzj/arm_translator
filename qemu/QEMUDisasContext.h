...
public:
    explicit QEMUDisasContext(jit::ExecutableMemoryAllocator* allocate, void* dispDirect, void* dispIndirect);
    ...
    virtual void gen_vfp_adds(TCGv_i32 ret, TCGv_i32 arg1, TCGv_i32 arg2, int isNeon) override;
    virtual void gen_vfp_subs(TCGv_i32 ret, TCGv_i32 arg1, TCGv_i32 arg2, int isNeon) override;
    virtual void gen_vfp_muls(TCGv_i32 ret, TCGv_i32 arg1, TCGv_i32 arg2, int isNeon) override;
    virtual void gen_vfp_divs(TCGv_i32 ret, TCGv_i32 arg1, TCGv_i32 arg2, int isNeon) override;

    virtual void gen_vfp_addd(TCGv_i64 ret, TCGv_i64 arg1, TCGv_i64 arg2, int isNeon) override;
    virtual void gen_vfp_subd(TCGv_i64 ret, TCGv_i64 arg1, TCGv_i64 arg2, int isNeon) override;
    virtual void gen_vfp_muld(TCGv_i64 ret, TCGv_i64 arg1, TCGv_i64 arg2, int isNeon) override;
    virtual void gen_vfp_divd(TCGv_i64 ret, TCGv_i64 arg1, TCGv_i64 arg2, int isNeon) override;

    virtual void gen_vfp_touis(TCGv_i32 ret, TCGv_i32 arg, int isNeon) override;
    virtual void gen_vfp_touizs(TCGv_i32 ret, TCGv_i32 arg, int isNeon) override;
    virtual void gen_vfp_tosis(TCGv_i32 ret, TCGv_i32 arg, int isNeon) override;
    virtual void gen_vfp_tosizs(TCGv_i32 ret, TCGv_i32 arg, int isNeon) override;

    virtual void gen_vfp_touid(TCGv_i32 ret, TCGv_i64 arg, int isNeon) override;
    virtual void gen_vfp_touizd(TCGv_i32 ret, TCGv_i64 arg, int isNeon) override;
    virtual void gen_vfp_tosid(TCGv_i32 ret, TCGv_i64 arg, int isNeon) override;
    virtual void gen_vfp_tosizd(TCGv_i32 ret, TCGv_i64 arg, int isNeon) override;

    virtual void gen_vfp_sitos(TCGv_i32 ret, TCGv_i32 arg, int isNeon) override;
    virtual void gen_vfp_uitos(TCGv_i32 ret, TCGv_i32 arg, int isNeon) override;

    virtual void gen_vfp_sitod(TCGv_i64 ret, TCGv_i32 arg, int isNeon) override;
    virtual void gen_vfp_uitod(TCGv_i64 ret, TCGv_i32 arg, int isNeon) override;
...
#define tcg_add_param_tl tcg_add_param_i64
    ...
    TCGv_ptr get_fpstatus_ptr(int neon);
