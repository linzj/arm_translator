...
CommonValues::CommonValues(LContext context)
    ...
    , int32NegativeOne(constInt(int32, -1, SignExtend))
    , int32ThirtyTwo(constInt(int32, 32))
    , int32Eight(constInt(int32, 8))
    , int32Sixteen(constInt(int32, 16))
    , int32TwoFiveFive(constInt(int32, 0xff))
